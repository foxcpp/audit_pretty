...
@pretty_printer('USER_LOGOUT', 1113)
def user_login(msg, suffix='') -> str:
    return generic_user_event('User logged out', msg, suffix)
...
@main_info_filter('ADD_USER', 'DEL_USER')
def user_crud_info(msg):
    m = msg.copy()
