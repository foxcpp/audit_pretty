...
def main():
    ...
    if args.version:
        ...
        print('Copyright (c) 2018 hkettu. Published under terms of the MIT license.')
        print()
        print('- Bugtracker: https://github.com/hkettu/audit_pretty/issues')
        print('- Source code: https://github.com/hkettu/audit_pretty/')
        return
